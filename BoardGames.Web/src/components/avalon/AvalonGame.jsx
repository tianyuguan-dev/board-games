...
const ROLE_IMAGES = {
  Merlin: "/Merlin.png?v=2",
  Percival: "/Percival.png?v=2",
  LoyalServant: "/Loyal_Servant_of_Arthur_clean.png?v=2",
  Assassin: "/Assassin.png?v=2",
  Morgana: "/Morgana.png?v=2",
  Mordred: "/Mordred.png?v=2",
  Oberon: "/Oberon.png?v=2",
  MinionOfMordred: "/Minion_of_Mordred_clean.png?v=2",
};
      ...
      >
        {roomPlayers.map((p, i) => (
          ...
          >
            ...
            {p.nickname}
            {p.isHost && <img src="/leader.png?v=2" alt="Host" className="lobby-host-icon" />}
    ...
    <div className="av-container">
          ...
          return (
            ...
            >
              <span className="player-name">
                {name}
                {isCurrLeader && <img src="/leader.png?v=2" alt="Leader" className="leader-icon" />}
                {(onTeam || selected) && <img src="/team.png?v=2" alt="On team" className="team-icon" />}
              </span>
      ...
      <div className="av-actions">
                ...
                return (
                  <div key={i} className="team-slot-wrap">
                    <div className={`team-slot ${filled ? "filled" : "empty"}`}>
                      {filled && <img src="/team.png?v=2" alt="" />}
                    </div>
              ...
              <div className="proposed-team-members">
                {gs.proposedTeam.map((i) => (
                  <span key={i} className="proposed-team-member">
                    <img src="/team.png?v=2" alt="" className="proposed-team-icon" />
                    {gs.playerNames[i]}
                  </span>
                ))}
              </div>
            ...
            {hasVoted ? (
              ...
              <div className="vote-night-panel">
                ...
                <div className="vote-btn-row">
                  ...
                  >
                    <span className="vote-img-frame"><img src="/approve.png?v=2" alt="" /></span>
                  </button>
                  <button
                  ...
                  >
                    <span className="vote-img-frame"><img src="/reject.png?v=2" alt="" /></span>
                  </button>
                </div>
              </div>
            )}
              ...
              hasPlayedCard ? (
                ...
                <div className="mission-task-panel">
                  ...
                  <div className="vote-btn-row">
                    ...
                    >
                      <span className="vote-img-frame"><img src="/success.png?v=2" alt="" /></span>
                    </button>
                    <button
                      className="vote-img-btn vote-reject"
                    ...
                    >
                      <span className="vote-img-frame"><img src="/fail.png?v=2" alt="" /></span>
                    </button>
                  </div>
                </div>
              )
        ...
        {gs.phase === "GameOver" && (() => {
          ...
          const gameoverBg =
            gs.winner === "Good" ? "/good-win.png?v=2" :
                ...
                <div className="progress-status" style={{ marginTop: 16 }}>
                  {roomPlayers.map((p, i) => (
                    <span key={i} className={`status-chip ${p.isHost || p.isReady ? "acted" : "pending"}`}>
                      {p.nickname}
                      {p.isHost && <img src="/leader.png?v=2" alt="Host" className="status-chip-host" />}
                    </span>
                  ))}
                </div>
              </div>
